...
for key in train_dic:
    ...
    for sub_key in train_sub_dic:
        ...
        f_all = open('data/plus_remove_less/'+key+"."+sub_key+".all.txt", 'w')

        train_docs = train_sub_dic[sub_key]
        f = open('data/plus_remove_less/'+key+"."+sub_key+".train.removeQN.txt", 'w')
        ...
        f = open('data/plus_remove_less/'+key+"."+sub_key+".test.txt", 'w')
